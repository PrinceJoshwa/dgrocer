...
export default function HeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FDFBF7] via-white to-emerald-50/30 overflow-hidden pt-20 md:pt-0"
    >
      {/* ==============================
          BACKGROUND ELEMENTS
         ============================== */}
      <motion.div style={{ y, opacity }} className="absolute inset-0 pointer-events-none">
        {/* Gradient Orbs */}
        <motion.div
          animate={{ scale: [1, 1.3, 1], rotate: [0, 180, 360], x: [0, 50, 0] }}
          transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
          className="absolute -top-[20%] -right-[10%] w-[700px] h-[700px] bg-gradient-to-br from-emerald-200/40 to-emerald-100/20 rounded-full blur-[120px]"
        />
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            {/* Badge */}
            <motion.div variants={fadeUpVariants} className="flex justify-center lg:justify-start">
              <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-emerald-50 to-emerald-100 border border-emerald-200 text-emerald-800 text-xs font-bold tracking-widest uppercase shadow-sm">
                <Star className="w-3.5 h-3.5 fill-emerald-600 text-emerald-600" />
            ...
            <motion.h1
              variants={textRevealVariants}
              className="text-6xl md:text-7xl lg:text-[6rem] leading-[0.9] font-black text-transparent bg-clip-text bg-gradient-to-br from-[#044116] via-[#055a1a] to-[#044116]"
            >
              D&apos;GROCER
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-slate-600 leading-relaxed max-w-lg mx-auto lg:mx-0"
            >
              Premium dry fruit gift boxes and hampers starting from just ₹199.
              Perfect for family, friends, corporates, and festive bulk orders.
            </motion.p>
            ...
            <motion.div variants={fadeUpVariants} className="pt-4 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-[#044116] to-[#055a1a] text-white font-bold rounded-full shadow-2xl"
              >
                Explore Gift Hampers
              </motion.a>

              <div className="flex items-center justify-center gap-2 px-6 py-4 text-[#044116] font-semibold bg-emerald-50 rounded-full border border-emerald-100">
                Healthy • Fresh • Premium Quality
              </div>
            </motion.div>
          </div>
          ...
          {/* ==============================
              RIGHT IMAGE
             ============================== */}
          <motion.div variants={fadeUpVariants} className="relative flex justify-center lg:justify-end">
            <div className="relative p-5 bg-white/50 backdrop-blur-xl border border-white/60 rounded-[2rem] shadow-2xl">
              <div className="relative rounded-3xl overflow-hidden aspect-[4/5] max-w-md mx-auto">
                <motion.img
                  whileHover={{ scale: 1.1 }}
                  transition={{ duration: 0.6 }}
                  src="https://res.cloudinary.com/dhgdjsfqh/image/upload/v1766821284/ok_one_1_fn9fcw.png"
                  alt="D'GROCER Premium Dry Fruit Gift Hampers"
                  className="w-full h-full object-cover"
                />
              </div>
            </div>
